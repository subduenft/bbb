 ...
 */
var isValidProtocol = function (protocolAddress) {
    var checkSumAddress = web3_1.default.utils.toChecksumAddress(protocolAddress);
    var validProtocolAddresses = [
        constants_1.CROSS_CHAIN_SEAPORT_ADDRESS,
        constants_1.CROSS_CHAIN_SEAPORT_V1_4_ADDRESS,
    ].map(function (address) { return web3_1.default.utils.toChecksumAddress(address); });
