import { ConsiderationItem, OrderWithCounter } from "@opensea/seaport-js/lib/types";
...
export declare type FulfillmentDataResponse = {
    protocol: string;
    fulfillment_data: FulfillmentData;
};
declare type FulfillmentData = {
...
declare type CollectionCriteria = {
    slug: string;
};
declare type ContractCriteria = {
    address: string;
};
declare type PartialParameters = {
