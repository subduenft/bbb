...
var OpenSeaSDK = /** @class */ (function () {
    ...
    function OpenSeaSDK(provider, apiConfig, logger, wallet) {
        ...
        this.seaport = new seaport_js_1.Seaport(providerOrSinger, {
    ...
    OpenSeaSDK.prototype.getFees = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                openseaSellerFeeBasisPoints = (0, utils_1.feesToBasisPoints)(osFees);
                collectionSellerFeeBasisPoints = (0, utils_1.feesToBasisPoints)(creatorFees);
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.seaport_v1_4.createOrder({
                                offer: [
                                    {
                                        token: paymentTokenAddress,
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, this.api.postOrder(order, {
                                protocol: "seaport",
                                protocolAddress: constants_1.CROSS_CHAIN_SEAPORT_V1_4_ADDRESS,
                                side: "bid",
                            })];
                }
            });
    ...
    OpenSeaSDK.prototype.createSellOrder = function (_a) {
        var _b;
        var asset = _a.asset, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, _c = _a.quantity, quantity = _c === void 0 ? 1 : _c, domain = _a.domain, salt = _a.salt, listingTime = _a.listingTime, expirationTime = _a.expirationTime, _d = _a.paymentTokenAddress, paymentTokenAddress = _d === void 0 ? constants_2.NULL_ADDRESS : _d, buyerAddress = _a.buyerAddress;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this._getPriceParameters(types_1.OrderSide.Buy, paymentTokenAddress, (0, utils_1.makeBigNumber)(expirationTime !== null && expirationTime !== void 0 ? expirationTime : (0, utils_1.getMaxOrderExpirationTimestamp)()), (0, utils_1.makeBigNumber)(amount))];
                    case 3:
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.seaport_v1_4.createOrder(payload, accountAddress)];
                    case 5:
    ...
    OpenSeaSDK.prototype.fulfillPrivateOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var counterOrder, fulfillments, seaport, transaction, transactionReceipt;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!(0, utils_1.isValidProtocol)(order.protocolAddress)) {
                        ...
                        seaport = order.protocolAddress === constants_1.CROSS_CHAIN_SEAPORT_ADDRESS
                            ? this.seaport
                            : this.seaport_v1_4;
                        return [4 /*yield*/, seaport
                                .matchOrders({
    ...
    OpenSeaSDK.prototype.fulfillOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var result, signature, isPrivateListing, seaport, executeAllActions, transaction;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(0, utils_1.isValidProtocol)(order.protocolAddress)) {
    ...
    OpenSeaSDK.prototype.cancelSeaportOrders = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var seaport, transaction;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!protocolAddress) {
                            protocolAddress = constants_1.CROSS_CHAIN_SEAPORT_ADDRESS;
                        }
                        seaport = protocolAddress === constants_1.CROSS_CHAIN_SEAPORT_ADDRESS
                            ? this.seaport
                            : this.seaport_v1_4;
                        return [4 /*yield*/, seaport
    ...
    OpenSeaSDK.prototype.setDomain = function (domain) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.seaport.setDomain(domain).transact()];
                    case 1:
                        transaction = _a.sent();
                        return [4 /*yield*/, transaction.wait()];
                    case 2:
    ...
    OpenSeaSDK.prototype.getDomain = function (tag, index) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.seaport.getDomain(tag, index)];
            });
        });
    };
    /**
    ...
    OpenSeaSDK.prototype.getDomains = function (tag) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.seaport.getDomains(tag)];
            });
        });
    };
    /**
    ...
    OpenSeaSDK.prototype.getNumberOfDomains = function (tag) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new bignumber_js_1.BigNumber(this.seaport.getNumberOfDomains(tag).toString())];
            });
        });
    };
    /**
    ...
    OpenSeaSDK.prototype._validateMatch = function (_a, retries) {
        ...
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var buyValid, sellValid, canMatch, calldataCanMatch, error_7;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 7, , 10]);
                    ...
                    case 7:
                        error_7 = _d.sent();
                        if (retries <= 0) {
                            throw new Error("Error matching this listing: ".concat(error_7 instanceof Error ? error_7.message : "", ". Please contact the maker or try again later!"));
                        }
                        return [4 /*yield*/, (0, utils_1.delay)(500)];
                    case 8:
                        _d.sent();
                ...
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, Promise.all(wyAssets.map(function (wyAsset, i) { return __awaiter(_this, void 0, void 0, function () {
                                var schemaName, isOwner, error_8, minAmount, _a, wyNFTAsset, wyFTAsset;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
    ...
    OpenSeaSDK.prototype._atomicMatch = function (_a) {
        var buy = _a.buy, sell = _a.sell, accountAddress = _a.accountAddress, _b = _a.metadata, metadata = _b === void 0 ? constants_2.NULL_BLOCK_HASH : _b;
        return __awaiter(this, void 0, void 0, function () {
            var value, shouldValidateBuy, shouldValidateSell, txHash, txnData, args, gasEstimate, error_9, error_10;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 10:
                        error_9 = _c.sent();
                        console.error("Failed atomic match with args: ", args, error_9);
                        throw new Error("Oops, the Ethereum network rejected this transaction :( The OpenSea devs have been alerted, but this problem is typically due an item being locked or untransferrable. The exact error was \"".concat(error_9 instanceof Error
                            ? error_9.message.substr(0, debugging_1.MAX_ERROR_LENGTH)
                            : "unknown", "...\""));
                    case 11:
                    ...
                    case 13:
                        ...
                        throw new Error("Failed to authorize transaction: \"".concat(error_10 instanceof Error && error_10.message
                            ? error_10.message
                            : "user denied", "...\""));
    ...
    OpenSeaSDK.prototype.authorizeOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var signerAddress, signerOrderNonce, orderForSigning, message, ecSignature, error_11;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    OpenSeaSDK.prototype._confirmTransaction = function (transactionHash, event, description, testForSuccess) {
        return __awaiter(this, void 0, void 0, function () {
            var transactionEventData, error_12;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 6:
                        ...
                        this._dispatch(types_1.EventType.TransactionFailed, __assign(__assign({}, transactionEventData), { error: error_12 }));
                        throw error_12;
                    case 7: return [2 /*return*/];
                }
            });
